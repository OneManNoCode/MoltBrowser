...
void AddChromeColorMixer(ui::ColorProvider* provider,
  ...
  // MoltBrowser dark-glass tones. Force-dark (browser_widget.cc) already makes
  // every foreground light; here we only deepen the surfaces dark-mode leaves
  // too flat and set the translucent-white floating-pill fill + specular edges.
  // Placed last in the normal-mode path so these win; the high-contrast block

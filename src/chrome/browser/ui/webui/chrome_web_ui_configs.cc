...
void RegisterChromeWebUIConfigs() {
  ...
  map.AddWebUIConfig(std::make_unique<MoltNetUIConfig>());
  map.AddWebUIConfig(std::make_unique<MoltImportUIConfig>());
  ...
  map.AddWebUIConfig(std::make_unique<MoltAIUpdateUIConfig>());

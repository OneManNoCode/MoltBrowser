...
void LocationBarView::RefreshBackground() {
  ...
  // MoltBrowser: give the omnibox capsule a faint specular edge so it reads as
  // a floating glass pill on the dark toolbar. High-contrast / input-mismatch
  // branches below override it when applicable.

...
class MoltNetBubbleView;  // MoltBrowser: glass MoltNet toolbar popover.
class MoltImportBubbleView;  // MoltBrowser: glass Import toolbar popover.
...
class VIEWS_EXPORT BubbleDialogDelegateView : public View,
 ...
 private:
  ...
  // MoltBrowser: the MoltNet glass toolbar popover is a BubbleDialogDelegateView
  // subclass; like every other bubble it must be a friend to construct via the
  // pass-key ctor. (Yes, the list is "closed" upstream — this fork adds one.)
  friend class ::MoltNetBubbleView;
  // MoltBrowser: the Import glass toolbar popover is a BubbleDialogDelegateView
  // subclass; like every other bubble it must be a friend to construct via the
  // pass-key ctor.
  friend class ::MoltImportBubbleView;

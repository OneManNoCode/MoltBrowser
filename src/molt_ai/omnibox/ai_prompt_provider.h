...
#ifndef COMPONENTS_OMNIBOX_BROWSER_AI_PROMPT_PROVIDER_H_
#define COMPONENTS_OMNIBOX_BROWSER_AI_PROMPT_PROVIDER_H_
...
#endif  // COMPONENTS_OMNIBOX_BROWSER_AI_PROMPT_PROVIDER_H_
